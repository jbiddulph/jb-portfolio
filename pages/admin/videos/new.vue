<template>
  <div>
    <div class="mb-6 sm:mb-8">
      ...
      <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Add New Video</h1>
      <p class="mt-1 sm:mt-2 text-sm sm:text-base text-gray-600">Add a new video showcase to your homepage</p>
    </div>
